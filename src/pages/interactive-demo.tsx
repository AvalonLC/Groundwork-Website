      ...
      <section class="section" style="padding-top: 32px;">
        <div class="wrap">
          ...
          <div data-demo-root>
            ...
            <div class="pm" style="grid-template-columns: 1fr; min-height: 560px; box-shadow: var(--shadow-lg);">
              <PMMain>
                {/* ---- Stop 1: Today ---- */}
                  ...
                  <div class="demo-workspace" style="min-height: 380px;">
                    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px;">
                      <div>
                        ...
                        <div class="demo-lead-card" data-demo-lead="grumley" style="background: var(--gw-cream-200); border-radius: 6px; padding: 10px; margin-bottom: 6px;"><div style="font-size: 12px; font-weight: 600;">Julie Grumley</div><div style="font-size: 10.5px; color: var(--gw-ink-500);">Tree Removal · $8.2k</div></div>
                        <div class="demo-lead-card" data-demo-lead="dhulipala" style="background: var(--gw-cream-200); border-radius: 6px; padding: 10px;"><div style="font-size: 12px; font-weight: 600;">Vijay Dhulipala</div><div style="font-size: 10.5px; color: var(--gw-ink-500);">Backyard · $32k</div></div>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div class="demo-lead-card" data-demo-lead="lampard" style="background: var(--gw-cream-200); border-radius: 6px; padding: 10px;"><div style="font-size: 12px; font-weight: 600;">Sydney Lampard</div><div style="font-size: 10.5px; color: var(--gw-ink-500);">Deck lighting · $18k</div></div>
                      </div>
                      <div>
                    ...
                    <div style="padding: 16px 18px 20px; border-top: 1px solid rgba(255,255,255,0.08);">
                      ...
                      {aiDeals.map((d, i) => (
                        ...
                        >
                          ...
                          <div class="demo-ai-detail" data-demo-ai-detail hidden>{d.action}</div>
                        </div>
                      ))}
                    </div>
                  </div>
